...
# Map the led output to the 16 LEDs
# Note that product[0] is LSB and product[15] is MSB
# Good Luck!
...
set_property PACKAGE_PIN W15 [get_ports {input_1[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {input_1[4]}]
set_property PACKAGE_PIN V15 [get_ports {input_1[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {input_1[5]}]
set_property PACKAGE_PIN W14 [get_ports {input_1[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {input_1[6]}]
set_property PACKAGE_PIN W13 [get_ports {input_1[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {input_1[7]}]
set_property PACKAGE_PIN V2 [get_ports {input_2[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {input_2[0]}]
set_property PACKAGE_PIN T3 [get_ports {input_2[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {input_2[1]}]
set_property PACKAGE_PIN T2 [get_ports {input_2[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {input_2[2]}]
set_property PACKAGE_PIN R3 [get_ports {input_2[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {input_2[3]}]
set_property PACKAGE_PIN W2 [get_ports {input_2[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {input_2[4]}]
set_property PACKAGE_PIN U1 [get_ports {input_2[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {input_2[5]}]
set_property PACKAGE_PIN T1 [get_ports {input_2[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {input_2[6]}]
set_property PACKAGE_PIN R2 [get_ports {input_2[7]}]					
...
set_property PACKAGE_PIN U2 [get_ports {data_ready}]					
